...
/**
 * @typedef {Object} FallingPatternProps
 * @property {string} [color] - Primary color of the falling elements (default: '#a855f7')
 * @property {string} [backgroundColor] - Background color (default: '#000000')
 * @property {number} [duration] - Animation duration in seconds (default: 150)
 * @property {string} [blurIntensity] - Blur intensity for the overlay effect (default: '1em')
 * @property {number} [density] - Pattern density - affects spacing (default: 1)
